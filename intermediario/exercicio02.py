...
-> Crie uma função que encontra os dois primeiros números duplicados na 
lista interna
    Requisitos:
        A ordem dos números duplicados é considerada a partir da segunda
        ocorrência (o número duplicado entre si).
        Exemplo: [1, 2, 3, ->3<-, 2, 1] 3
        Se não encontrar duplicadas na lista, retorne -1
